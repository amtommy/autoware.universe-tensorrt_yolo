...
#ifndef TENSORRT_YOLO__NODELET_TWO_CAMERAS_HPP_
#define TENSORRT_YOLO__NODELET_TWO_CAMERAS_HPP_
...
{
class TensorrtYoloNodeletTwoCameras : public rclcpp::Node
{
public:
...
#endif  // TENSORRT_YOLO__NODELET_TWO_CAMERAS_HPP_
